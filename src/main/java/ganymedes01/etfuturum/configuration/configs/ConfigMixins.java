...
public class ConfigMixins extends ConfigBase {
	...
	public static boolean enableRandomTickSpeed;
	...
	public static boolean snowReplaceableFix;
  ...
  public static boolean enableJumpClimbing;
	...
	protected void syncConfigOptions() {
		...
		signs = getBoolean("signs", catBackport, true, "Allows signs to inerhit modern features (editing, double sided, waxing).\nModified Classes: net.minecraft.block.BlockSign net.minecraft.item.ItemSign net.minecraft.tileentity.TileEntitySign net.minecraft.client.renderer.tileentity.TileEntitySignRenderer");
		snowReplaceableFix = getBoolean("snowReplaceableFix", catBackport, true, "Makes snow only overwritable by other blocks when it's a single layer (matching modern MC). Snow can still stack on itself.\nModified Classes: net.minecraft.block.BlockSnow net.minecraft.item.ItemSnow");
        ...
        enableJumpClimbing = getBoolean("enableClimbingPlants", catBackport, true, "Allows players to simply hold jump to climb up climable blocks instead of having to collide with something horizontally.");
	}
}
